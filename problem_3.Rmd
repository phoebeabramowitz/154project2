...
```{r}
# trying adaboost, since ill want to do it in part 4. once the CVgeneric is up and running, we can include this as an else is..
# the book does gbm which is just normal boosting, and adabad runs adaboost, though im having issues with it...

# split1
boost1 <- gbm(cloud_label ~.,
              data = imagestrain,
              distribution = "gaussian")

boost1.pred <- predict(boost1, imagesval, n.trees = 100)
# need to do something similar to logistic for these values.. 
```
