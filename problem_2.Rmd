...
# the split functions need lists, so it only works with tiny_image_list !!!

#knn
CVgeneric(classifier="knn", data=tiny_image_list, k=10, loss=zero_one_loss, splitter=split1)
CVgeneric(classifier="knn", data=tiny_image_list, k=10, loss=zero_one_loss, splitter=split2)

#glm
CVgeneric(classifier="glm", data=tiny_image_list, k=10, loss=zero_one_loss, splitter=split1)
...
#qda
CVgeneric(classifier="qda", data=tiny_image_list, k=10, loss=zero_one_loss, splitter=split1)
CVgeneric(classifier="qda", data=tiny_image_list, k=10, loss=zero_one_loss, splitter=split2)
       
```
```{r}
# gonna try CVgeneric on all the data now..
