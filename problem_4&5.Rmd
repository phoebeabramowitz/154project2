...
ggplot(just_errors)+
  geom_histogram(aes(x=CORR),fill="red",alpha=0.3,bins=50)+
  aes(y=stat(count)/sum(stat(count))) + 
  geom_histogram(data=imagestest,aes(x=CORR),fill="blue", alpha=0.3,bins=50)+
  scale_y_continuous(labels = scales::percent)+
...
ggplot(just_errors)+
  geom_histogram(aes(x=SD,color="Errors"),fill="red",alpha=0.3,bins=50)+
  aes(y=stat(count)/sum(stat(count))) + 
  geom_histogram(data=imagestest,aes(x=SD),fill="blue", alpha=0.3,bins=50)+
  scale_y_continuous(labels = scales::percent)+
