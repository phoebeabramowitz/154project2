...
Two ways:
1) Split the datasets into 80% train, 10% validation, and 10% test without any transformations.
...
2) Take 3pixel X 3pixel blocks and create 'super pixels' to transform the data into a new set. This will decrease the number of data points, but should help reconcile the dependence relationship between the points by blurring the overall data.
