...
radiance angles are all highly correlated with eachother, so their relationship to the expert label is largely the same. ive included the violin plot for rad_DF only, since the other radiance angles had similar violin plots. We see drastic differences of the violin plots for NDAI, SD, and CORR. (write more about this.. what patterns do you see?)