...
#Define your “best” feature criteria clearly
  ...
  We also compare CORR and SD, and while they have greater error than to NDAI, they have clearer distinctions than the individual radiance angles. In an attempt to aggregate the collective information provided by the five radiance angles, we performed Principal Component Analysis on these angles, and plotted the overlapped histogram to determine whether or not the first principal component is particularly useful as a classification feature. 
