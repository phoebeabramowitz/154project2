...
```{r}
# relationship between SD and expert labels
...
```
```{r}
# relationship between rad_DF and expert labels
...
```{r}
# relationship between rad_CF and expert labels
...
```
```{r}
# relationship between rad_BF and expert labels
...
```
```{r}
# relationship between rad_AF and expert labels
...
```
```{r}
# relationship between rad_AN and expert labels
