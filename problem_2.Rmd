...
CVgeneric(classifier="glm", data=tiny_image_list, k=10, loss=zero_one_loss, splitter=split2)
    
#lda
CVgeneric(classifier="lda", data=tiny_image_frame, k=10, loss=zero_one_loss, splitter=split1)
CVgeneric(classifier="lda", data=tiny_image_list, k=10, loss=zero_one_loss, splitter=split2)
 
#qda
CVgeneric(classifier="qda", data=tiny_image_frame, k=10, loss=zero_one_loss, splitter=split1)
CVgeneric(classifier="qda", data=tiny_image_list, k=10, loss=zero_one_loss, splitter=split2)
