...
Since we're using cross-validation to choose models, we merge validation set into the test set, for 20% of the data in total. We train the data on the remaining 80% of the entire set. 
```{r}
#dataframe setup
