...
ggplot(new1, aes(x=NDAI, colour=cloud_label, fill=cloud_label)) + geom_histogram(alpha=0.2, bins=50) + theme_classic() + ggtitle("Histogram of NDAI count based on cloud label: image1") 

# something is wrong here... this looks different than the first instagram below but I don't know why. 
```
