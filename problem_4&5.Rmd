...
CVmodel_accuracy("gbm", boost_imagestrain, 10, zero_one_loss, ".", "cloud_label")
CVmodel_accuracy("gbm", tboost_imagestrain, 10, zero_one_loss, ".", "cloud_label")
...
mean(boost_pred == boost_imagestest$cloud_label)
...
3 a) Phoebe Omri b) Omri c) *do we want to do the bonus?*
4 a) b c) d) e)
5 
